    ...
    <div className="dashboard-page inventory-theme">
      <aside className="dashboard-sidebar">
        ...
        <div className="quick-links">
          ...
          <button className="quick-link" type="button" onClick={() => navigate('/orders')}>All Orders</button>
      ...
      <main className="dashboard-main">
        ...
        <section className="audit-header-row">
          <button type="button" className="audit-back-btn" onClick={() => navigate('/orders')}><ArrowLeft size={16} />Back</button>
          <div>
