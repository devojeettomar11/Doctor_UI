...
// Fixed: component name changed to PascalCase (was lowercase which caused React to treat it as HTML)
const DoctorSidebar = ({ onNavClick }) => {
  return (
    <aside className="w-full md:w-56 min-h-screen bg-white border-r border-gray-200 flex flex-col">
      ...
      <div className="p-4 border-t border-gray-200">
        <div className="flex items-center gap-2">
          ...
          <div className="min-w-0">
            <p className="text-xs font-medium text-gray-900 truncate">Doctor</p>
